...
![image_du_contenu_du_dossier_fipy](../img/contenu_dossier_fipy.png)
...
![image_du_contenu_du_dossier_fipy_avec_exemple](../img/ContenuDuDossierFipyAvecExemple.png)
...
![Schema de cablage](../img/Schemat_cablage.png)
```Bash 
sudo gateway-config
