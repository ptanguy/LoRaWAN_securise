...
\paragraph{}
Pour palier à ce problème nous avons décidés de programmer les différentes contres mesures dans un programme simple dans lequel nous avons dissimulés une variable contenant des clés.

\subsection{Tests Unitaire}
\paragraph{}
Pour tester le fonctionnement de la contre mesure \textbf{RDP} nous l'avons implanté dans notre programme de test. 
